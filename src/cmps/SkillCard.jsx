export function SkillCard({ skill }) {
    ...
    const icon = svgIcons[iconKey] || <div className="fallback-icon">?</div>;

    return (
        <div className="skill-card">
            <div className="skill-icon">{icon}</div>
            <h3 className="skill-name">{skill || 'Unknown Skill'}</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Aspernatur eligendi magnam esse odio veniam maiores iste
                deleniti nostrum corporis a!
                Atque vitae soluta vero,
                pariatur omnis cumque facere architecto corrupti.</p>
        </div>
    );
}